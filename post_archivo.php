<?php
  //VERIFICA QUE LOS DATOS RECIBIDOS ESTEN COMPLETOS, Y LUEGO AGREGA EL ARCHIVO AL ART�CULO
  
  include_once("inicializar.php");
  include_once('./login_logout.php');

  //AGREGA EL ARCHIVO CON NOMBRE $nombre AL ART�CULO $id_articulo
  ...
  if (hay_alguien()){
  	...
  	} else // SI NO CARG� EL NOMBRE DEL ARCHIVO
  		{
