<?php
  //VERIFICA QUE LOS DATOS RECIBIDOS ESTEN COMPLETOS, Y LUEGO AGREGA LA IMÁGEN AL ARTÍCULO
  include_once("DB.php");
  include_once("inicializar.php");
  include_once('./login_logout.php');
  
  //AGREGA LA IMÁGEN AL ARTÍCULO $id_articulo
  ...
  if (hay_alguien()){
  	...
  	if ( validarStrings(array($_POST['altern'])) ){
  			...
  			if (es_duenio_del_articulo($_GET['id'])){
  						...
  						//COMPRUEBA QUE LA EXTENSION SEA DE UNA IMÁGEN
  						if (substr($tipo,0,5)!="image"){
  							...
  							if ($archivo != "") {
  								if (!(file_exists('./files'))){
  							        ...
  							        // GUARDAMOS LA IMÁGEN EN LA CARPETA files
  								$destino =  "./files/".$prefijo."_".$archivo;
  								
  								//VERIFICA QUE SE HAYA GAURDADO LA IMÁGEN CORRECTAMENTE
  	...
  	} else // SI NO CARGÓ TEXTO ALTERNATIVO
  		{
